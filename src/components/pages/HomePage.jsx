  ...
  <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-900">
    ...
    <main className="flex-1 container mx-auto px-4 py-16 md:py-24 flex flex-col items-center text-center">
      ...
      <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 mb-6 max-w-4xl">
        Coleta anônima. <span className="text-indigo-600">Insights reais.</span>{" "}
        <br className="hidden md:block" />
        Decisões melhores.
      </h1>
      
      <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-2xl leading-relaxed">
        Veja como sua empresa pode transformar feedbacks brutos em ações
        estratégicas com o poder do Gemini — mantendo a identidade dos
        colaboradores 100% protegida.
      </p>
